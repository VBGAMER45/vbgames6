...
if (ToolBar_Supported)
{
	...
	HTMLStr =
		"<DIV ID='idToolbar'     STYLE='background-color:BLACK;width:100%'>" +
		...
		"<DIV ID='idMSMenuPane'  STYLE='position:absolute;top:0;left:250;height:20;width:10;background-color:black;float:right;' NOWRAP><!--MENU_TITLES--></DIV>" +
		"</DIV>" +
		"<DIV ID='idRow2' STYLE='position:relative;left:250;height:40;'>" +
		"<DIV ID='idADSBanner'   STYLE='position:absolute;top:0;left:0;height:40;width:200;vertical-align:top;overflow:hidden;'><!--BEG_BANNER--><!--END_BANNER--></DIV>" +
		"<DIV ID='idMSCBanner'   STYLE='position:absolute;top:0;left:200;height:40;width:112;vertical-align:top;overflow:hidden;' ALIGN=RIGHT><!--BEG_BANNER--><!--END_BANNER--></DIV>" +
		"</DIV>" +
...
{	setBanner(Gif,Url,AltStr,"<!--BEG_BANNER-->","<!--END_BANNER-->");
}
...
{	tempGif = "/library/toolbar/images/" + Gif;
	setBanner(tempGif,Url,AltStr,"<!--BEG_BANNER-->","<!--END_BANNER-->");
}
...
function prepTrackingString(ts, type)
{
	...
	if (7 == type)
	{
		...
		if(rString.indexOf("visualbasiczone.com") != -1)
		{
			rString = rString.substring(0,rString.indexOf("visualbasiczone.com"));
			if('' == rString)
			{
				rString = "www";
			}
